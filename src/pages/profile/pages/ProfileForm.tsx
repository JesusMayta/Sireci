...
export const ProfileForm = () => {
    return (
        <>
            <div className="bg-stone-300 rounded-xl">
                <div className='bg-blue-800 text-white h-10  text-justify rounded-t-xl'>Agregar Usuario</div>
                <div className='bg-neutral-500 text-white h-8 ml-3.5 mt-3 mb-4'>Completar los campos</div>

                <div>
                    <form className='w-full h-[600px]'>
