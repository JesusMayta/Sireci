...
export const ModalToUpdate = () => {

    const { startCloseEditModal } = useUiStore();
    const { activeCertificateMarriage, clearActiveCertificate, startEditMarriageDoc, startSendSuccessMessage, getAllCertificatesMarriage } = useMarriageDocsStore();
                            ...
                            <div className="px-8 mt-3">
                                <div className="w-full flex flex-row gap-x-4 mt-8">
                                    <div className="flex flex-col w-1/2">
                                        <p className="rounded-lg text-center bg-black text-white text-sm py-1 font-semibold">Datos del esposo</p>
                                    ...
                                    <div className="w-1/2">
                                        <p className="rounded-lg text-center bg-black text-white text-sm py-1 font-semibold">Datos de la esposa</p>
                                ...
                                <div className="w-full flex flex-row gap-x-4 mt-4">
                                    <div className="flex flex-col w-1/2">
                                        <label htmlFor="mar_date" className="rounded-lg text-center bg-black text-white text-sm py-1 font-semibold">Fecha de registro</label>
                                        <Field
