...
export const Navbar = () => {
  ...
  return (
    <nav className='sticky top-1 z-15 h-16 py-2 bg-gray-900 rounded-lg text-white shadow-lg shadow-gray-700'>
      <div className='h-full flex flex-row justify-between items-center mx-12'>
        <div className='flex items-center gap-x-10 w-1/2'>
          ...
          <button
            ...
            onClick={() => startOpenSidebar(true)}
          >
            <IoMenuSharp className='text-2xl sm:text-3xl' />
          </button>

          <p className='text-2xl sm:text-3xl md:text-4xl tracking-wider font-bold'>
            SIRECI
          </p>
        </div>
        ...
        <figure className='flex items-center gap-2'>
          ...
          <img
            src={photoUser}
            alt=''
            className='h-full w-9 md:w-11 rounded-full'
          />
        </figure>
      </div>
    </nav>
