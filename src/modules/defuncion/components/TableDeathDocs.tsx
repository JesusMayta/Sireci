...
export const TableDeathDocs = () => {
    ...
    const { isLoadingDocuments, deathCertificates, getAllCertificatesDeath } = useDocumentsStore();
    ...
    return (
        <div className="mt-8 h-full">
            {(filterPeople.length === 0) ? (
                <div className="flex justify-center mt-32 h-full text-3xl font-semibold">
